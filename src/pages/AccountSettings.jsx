...
export default function AccountSettings() {
 ...
 return (
  <>
   <Link to="/dashboard" className="absolute top-6 left-6 w-12 h-12 flex items-center justify-center rounded-full bg-teal-100 hover:bg-green-100 shadow-lg transition"><FaArrowLeft className="h-6 w-6 text-teal-700" /></Link>
  <div className="min-h-screen bg-gradient-to-br from-[#E0F7FA] to-[#F1F5F9] py-14 px-4 flex justify-center">
    <div className="w-full max-w-3xl backdrop-blur-lg bg-white/70 shadow-2xl border border-white/40 rounded-3xl p-10">
      ...
      <section className="p-6 bg-white/70 shadow-lg rounded-2xl border border-gray-200 mb-8 transition hover:shadow-xl">
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden shadow-lg ring-4 ring-teal-200/50">
           ...
           <h2 className="text-2xl font-semibold text-[#0A1A2F] mb-4">Admin Account</h2>
        </div>
      </section>

      {/* UPDATE PROFILE */}
      <section className="p-6 bg-white/70 shadow-lg rounded-2xl border border-gray-200 mb-8 transition hover:shadow-xl">
        <h2 className="text-2xl font-semibold text-[#0A1A2F] mb-4">Update Profile Details</h2>
        ...
        {/* CHANGE PASSWORD */}
        <section className="p-6 bg-white/70 shadow-lg rounded-2xl border border-gray-200 mb-8 transition hover:shadow-xl">
          <h2 className="text-2xl font-semibold text-[#0A1A2F] mb-4">Change Password</h2>
          <label className="font-medium text-gray-800">Current Password</label>
      ...
      <section className="p-6 bg-white/70 shadow-lg rounded-2xl border border-red-200 transition hover:shadow-xl">
        <h2 className="text-2xl font-semibold text-red-700 mb-3">Account Deletion</h2>

        <p className="text-gray-800 mb-4 text-sm">
          <strong>Warning:</strong> This action is <strong>permenent</strong> and cannot be undo.
        </p>
